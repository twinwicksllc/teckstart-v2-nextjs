      ...
      <CardContent className="space-y-4">
        ...
        >
          <span className="mr-2 h-4 w-4 inline-block align-middle">
            <img src="https://upload.wikimedia.org/wikipedia/commons/5/53/Google_%22G%22_Logo.svg" alt="Google logo" width="20" height="20" style={{ display: 'inline-block', verticalAlign: 'middle' }} />
          </span>
          Sign in with Google
        </Button>
      </CardContent>
